...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "ClapTraps.py"
 
        #Name of program
        self.project_name = "ClapTraps"
        ...
        #Auhor of program
        self.author_name = "Test Pilot Monkey"
        self.author_email = "testpilotmonkey@googlemail.com"
        self.copyright = "Copyright (c) 2010 testpilotmonkey."
 
        #Description
        self.project_description = "Game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "ct.ico"
